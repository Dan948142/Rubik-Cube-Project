...
class RubiksCubeBitboard : public RubikCube {
...
public:
    ...
    uint64_t getCorners() {
        ...
        top_front_right += getColorChar(getColor(Face::FRONT, 0, 2));
        top_front_right += getColorChar(getColor(Face::RIGHT, 0, 0));

        string top_front_left = "";
        top_front_left += getColorChar(getColor(Face::UP, 2, 0));
        top_front_left += getColorChar(getColor(Face::FRONT, 0, 0));
        top_front_left += getColorChar(getColor(Face::LEFT, 0, 2));

        string top_back_left = "";
        top_back_left += getColorChar(getColor(Face::UP, 0, 0));
        top_back_left += getColorChar(getColor(Face::BACK, 0, 2));
        top_back_left += getColorChar(getColor(Face::LEFT, 0, 0));

        string top_back_right = "";
        top_back_right += getColorChar(getColor(Face::UP, 0, 2));
        top_back_right += getColorChar(getColor(Face::BACK, 0, 0));
        top_back_right += getColorChar(getColor(Face::RIGHT, 0, 2));

        string bottom_front_right = "";
        bottom_front_right += getColorChar(getColor(Face::DOWN, 0, 2));
        bottom_front_right += getColorChar(getColor(Face::FRONT, 2, 2));
        bottom_front_right += getColorChar(getColor(Face::RIGHT, 2, 0));

        string bottom_front_left = "";
        bottom_front_left += getColorChar(getColor(Face::DOWN, 0, 0));
        bottom_front_left += getColorChar(getColor(Face::FRONT, 2, 0));
        bottom_front_left += getColorChar(getColor(Face::LEFT, 2, 2));

        string bottom_back_right = "";
        bottom_back_right += getColorChar(getColor(Face::DOWN, 2, 2));
        bottom_back_right += getColorChar(getColor(Face::BACK, 2, 0));
        bottom_back_right += getColorChar(getColor(Face::RIGHT, 2, 2));

        string bottom_back_left = "";
        bottom_back_left += getColorChar(getColor(Face::DOWN, 2, 0));
        bottom_back_left += getColorChar(getColor(Face::BACK, 2, 2));
        bottom_back_left += getColorChar(getColor(Face::LEFT, 2, 0));
